...
namespace DX
{
	...
	{
	public:
		DeviceResources(DXGI_FORMAT backBufferFormat = DXGI_FORMAT_B8G8R8A8_UNORM/*, DXGI_FORMAT depthResourceFormat = DXGI_FORMAT_R32_TYPELESS, DXGI_FORMAT depthBufferFormat = DXGI_FORMAT_D32_FLOAT*/);
	...
	private:
		...
		//DXGI_FORMAT										m_depthResourceFormat, m_depthBufferFormat;
