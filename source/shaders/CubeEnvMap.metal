...
vertex FS_P cubeenv_vs_main(const device VertexPN* input [[buffer(0)]],
...
fragment float4 cubeenv_fs_main(FS_P input [[stage_in]],
...
fragment float4 cubeir_fs_main(FS_P input [[stage_in]],
